...
import HeroImg from "../../../../../public/images/events/test.jpg";
          ...
          <div className="absolute top-[40%]">
            <LazyShow>
              <Container classNames="text-start">
                ...
                <br />
                <p className="text-sm sm:text-lg md:text-2xl w-full md:w-[60%]">
                  Welcome to the Scholarships page of Shree Bhotenamlang
                  Secondary School. We are committed to fostering academic
                  excellence and providing opportunities for deserving students
              ...
              <div>
                ...
                <div className="text-black grid grid-cols-1 sm:grid-cols-2 py-8 gap-10">
                  <div className="flex flex-col order-2 sm:order-1 gap-5">
                    ...
                    <p>
                      Provided by the HELP organization, this scholarship
                      supports around 50 students each year for two years,
                      aiming to assist those in need of financial aid to pursue
                      higher education.{" "}
                    </p>
                ...
                <div className="text-black grid grid-cols-1 sm:grid-cols-2 py-8 gap-10">
                  <div className="flex flex-col order-2 sm:order-1 gap-5">
                    ...
                    <p>
                      Offered by the Council for Technical Education and
                      Vocational Training, this scholarship aims to support
                      students pursuing technical education and vocational
                      training in various disciplines. It is awarded to 100
                      students annually.
                    </p>
                    <p className="text-lg font-semibold">Requirements:</p>
                    <ul>
                ...
                <div className="text-black grid grid-cols-1 sm:grid-cols-2 py-8 gap-10">
                  <div className="flex flex-col order-2 sm:order-1 gap-5">
                    <p className="text-xl font-bold">
                      3. Samantha Foundation Scholarship
                    </p>
                    <p>
                      Sponsored by the Samantha Foundation, this scholarship
                      assists underprivileged students in achieving their higher
                      education goals. It supports 75 students each year across
                ...
                <div className="text-black grid grid-cols-1 sm:grid-cols-2 py-8 gap-10">
                  <div className="flex flex-col order-2 sm:order-1 gap-5">
                    ...
                    <p>
                      The United World Colleges (UWC) Scholarship provides an
                      opportunity for students to attend one of the UWC schools
                      worldwide, focusing on academic excellence and fostering
                      international understanding. Around 50 scholarships are
                      awarded annually.
                    </p>
                    <p className="text-lg font-semibold">Requirements:</p>
                    <ul>
