  ...
  return (
    ...
    >
      <div
        style={{
          perspective: "1000px",
          transform: "rotateX(90deg) translateZ(0deg)",
        }}
        className="absolute left-1/2 top-1/2  mt-4 w-full "
      >
        <div
          style={{
            transform: transform,
      ...
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        <div className="absolute top-0 inset-x-0  flex justify-center">
          <a
            href={href}
            target={"_blank"}
            className="relative flex space-x-2 items-center z-10 rounded-full bg-green-700 py-0.5 px-4 ring-1 ring-white/10 "
          >
